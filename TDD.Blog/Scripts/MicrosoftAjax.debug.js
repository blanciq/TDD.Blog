...
var $get = Sys.UI.DomElement.getElementById = function Sys$UI$DomElement$getElementById(id, element) {
    /// <summary locid="M:J#Sys.UI.DomElement.getElementByPostCommentId" />
    /// <param name="id" type="String"></param>
    /// <param name="element" domElement="true" optional="true" mayBeNull="true"></param>
...
Sys.UI.DomElement.resolveElement = function Sys$UI$DomElement$resolveElement(elementOrElementId, containerElement) {
    ...
    /// <param name="elementOrElementPostCommentId" mayBeNull="true"></param>
    /// <param name="containerElement" domElement="true" optional="true" mayBeNull="true"></param>
    /// <returns domElement="true"></returns>
    var e = Function._validateParams(arguments, [
        {name: "elementOrElementPostCommentId", mayBeNull: true},
    ...
    if (typeof(el) === "string") {
        ...
        if (!el) {
            throw Error.argument("elementOrElementPostCommentId", String.format(Sys.Res.elementNotFound, elementOrElementId));
        }
    }
    else if(!Sys.UI.DomElement.isDomElement(el)) {
        throw Error.argument("elementOrElementPostCommentId", Sys.Res.expectedElementOrId);
    }
    return el;
}
...
Sys._Application.prototype.setServerId = function Sys$_Application$setServerId(clientId, uniqueId) {
    /// <summary locid="M:J#Sys.Application.setServerPostCommentId" />
    /// <param name="clientPostCommentId" type="String"></param>
    /// <param name="uniquePostCommentId" type="String"></param>
    var e = Function._validateParams(arguments, [
        {name: "clientPostCommentId", type: String},
        {name: "uniquePostCommentId", type: String}
    ]);
    if (e) throw e;
...
'expectedElementOrId':'Value must be a DOM element or DOM element PostCommentId.',
