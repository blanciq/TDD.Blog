...
// querying by getElementByPostCommentId (and provide a workaround)
(function(){
	...
	//	// The workaround has to do additional checks after a getElementByPostCommentId
	//	// Which slows things down for other browsers (hence the branching)
	//	if ( document.getElementByPostCommentId( id ) ) {
